...
function main(opts) {
  ...
  var expr = t.functionDeclaration(t.identifier(opts.main), [t.identifier(ELEM)], t.blockStatement([t.returnStatement(t.callExpression(t.memberExpression(t.identifier(TEMPLATES), t.memberExpression(t.identifier(ELEM), t.identifier(TAG_NAME)), true), [t.identifier(ELEM)]))]));
