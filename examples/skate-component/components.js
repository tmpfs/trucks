...
/***/ function(module, exports, __webpack_require__) {
	...
	var _define = __webpack_require__(15);
...
/***/ function(module, exports) {
	...
	var ctor = exports.ctor = '____skate_constructor';
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.shadowDomV1 = exports.shadowDomV0 = exports.customElementsV1 = exports.customElementsV0Polyfill = exports.customElementsV0 = exports.v1ShadowDOMProperty = exports.v0ShadowDOMProperty = undefined;
	exports.shouldUseShadowDomV0 = shouldUseShadowDomV0;
	exports.shouldUseShadowDomV1 = shouldUseShadowDomV1;
	
	var _regexNativeFunction = __webpack_require__(9);
	
	var _regexNativeFunction2 = _interopRequireDefault(_regexNativeFunction);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var div = document.createElement('div');
	var isNative = function isNative(elem, prop) {
	  return _regexNativeFunction2.default.test(elem[prop]);
	};
	...
	var v0ShadowDOMProperty = exports.v0ShadowDOMProperty = 'createShadowRoot';
	
	// property used to check for shadowDOMv1 support
	var v1ShadowDOMProperty = exports.v1ShadowDOMProperty = 'attachShadow';
	...
	var customElementsV0Polyfill = exports.customElementsV0Polyfill = customElementsV0 && !Document.prototype.registerElement;
	var customElementsV1 = exports.customElementsV1 = !!window.customElements;
	
	var shadowDomV0 = exports.shadowDomV0 = shouldUseShadowDomV0(div);
	var shadowDomV1 = exports.shadowDomV1 = shouldUseShadowDomV1(div);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _definePropertyConstructor = __webpack_require__(13);
	
	var _definePropertyConstructor2 = _interopRequireDefault(_definePropertyConstructor);
	
	var _getOwnPropertyDescriptors = __webpack_require__(14);
	...
	if (_support.customElementsV0Polyfill) {
	  var proto = HTMLElement.prototype;
	  window.HTMLElement = function () {
	    var ctor = this[_symbols.ctor];
	  ...
	  (0, _definePropertyConstructor2.default)(HTMLElement.prototype, HTMLElement);
	}
	...
	var Component = function (_HTMLElement) {
	  ...
	  _createClass(Component, [{
	    ...
	    value: function createdCallback() {
	      ...
	      // polyfill here.
	      if (_support.customElementsV0Polyfill) {
	        (0, _definePropertyConstructor2.default)(this, this[_symbols.ctor]);
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (name, opts) {
	  ...
	  if (_support.customElementsV0) {
	    ...
	    Ctor.prototype[_symbols.ctor] = Ctor;
	    Ctor.prototype[_symbols.name] = uniqueName;
	    var NewCtor = document.registerElement(uniqueName, Ctor);
	    (0, _definePropertyConstructor2.default)(NewCtor.prototype, Ctor);
	    return _support.customElementsV0Polyfill ? Ctor : NewCtor;
	...
	var _dashCase = __webpack_require__(18);
	...
	var _propsInit = __webpack_require__(19);
